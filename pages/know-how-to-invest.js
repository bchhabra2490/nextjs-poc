...
const KnowHowToInvestPage = ({ params }) => {
  ...
  const onSubmit = (formValues) => {
    ...
    values.page = 'know-how-to-invest';
    delete values.ref;
        ...
        <Container maxWidth={false} className={classes.container}>
                ...
                <Grid item xs={9} className={classes.bannerTitle}>
                  <Hidden smDown>
                    ...
                    <Typography
                      ...
                      align="left"
                    >
                      Don't have time to track the markets? We can help!
          ...
          <Grid container>
            <Grid item xs={12}>
              ...
              >
                Investing in the stock market can be time-consuming. We simplify this, by offering an actively managed portfolio service. We explain our every move, maintaining transparency and making you a better investor.
              </Typography>
            </Grid>
          </Grid>
...
export default KnowHowToInvestPage;
