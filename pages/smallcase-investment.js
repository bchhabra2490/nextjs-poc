...
const SmallcaseInvestmentPage = ({ location }) => {
  ...
  const onSubmit = (formValues) => {
    ...
    delete values.ref;
    values.page = 'smallcase-investment';
    console.log(values);
        ...
        <Container maxWidth={false} className={classes.container}>
          ...
          <Grid container>
            <Grid item xs={12} className={classes.banner}>
              <Grid container>
                ...
                {/* <Grid item xs={3} className={classes.bannerLogo}> */}
                {/* <Box /> */}
                {/* <img className={classes.bannerLogoImage} src={data.smallcaseLogo.childImageSharp.fluid.src} alt="" /> */}
                {/* </Grid> */}
          ...
          <Grid container>
            <Grid item xs={12}>
              ...
              >
                Now you can invest in an actively managed portfolio of stocks on smallcase with our Teji Mandi Flagship portfolio. Get regular portfolio rebalance updates and details of the 'why' behind our every move. Our goal is to make you a smarter investor.
              </Typography>
            </Grid>
          </Grid>
          {/* <Grid container>
          ...
          {/* <Grid container>
            <Grid item xs={3}>
              <Typography
                ...
                align="center"
                gutterBottom
                className="performance-values-text"
              >
                Value of Rs 100 invested on the launch of this portfolio on 28th May, 2020
              </Typography>
            </Grid>
            <Grid item xs={3}>
              <Typography
...
export default SmallcaseInvestmentPage;
